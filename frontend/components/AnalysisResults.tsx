  ...
  return (
    <div className="w-full max-w-2xl space-y-6 mt-8">
      ...
      <div className="bg-gray-50 rounded-xl p-4 border">
        ...
        <p className="text-gray-800">{original_transcript}</p>
      </div>
      ...
      <div className="bg-white rounded-xl p-5 border shadow-sm">
        <h3 className="font-bold text-gray-800 mb-3">Improved Versions</h3>
        <div className="mb-3">
          <span className="text-xs font-semibold uppercase text-blue-500">
            Corrected
          </span>
          <p className="text-gray-800 mt-1">{analysis.corrected_text}</p>
        </div>
        <div>
          <span className="text-xs font-semibold uppercase text-purple-500">
            Natural (native speaker)
          </span>
          <p className="text-gray-800 mt-1">{analysis.natural_version}</p>
        </div>
      </div>
